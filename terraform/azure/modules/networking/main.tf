...
# For Jenkins VM and general workloads
...
# Dedicated subnet for Kubernetes nodes
...
# bastion subnet for secure access to private resources
...
# Dedicated subnet for private endpoints (ACR)
